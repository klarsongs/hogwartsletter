var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}} // If you want to play with the options, the best way is to enable Dat GUI by setting the following boolean to true
...
var options = {
  ...
  maxParticles: 500,
  particleColors: [
  '242, 167, 30', '241, 207, 160', '211, 79, 39'],
  ...
  function ParticleSystem() {_classCallCheck(this, ParticleSystem);
    this.particles = [];
  }_createClass(ParticleSystem, [{ key: 'addParticle', value: function addParticle(
    ...
    } }, { key: 'removeParticle', value: function removeParticle()
...
var Particle = function () {
  function Particle(opts) {_classCallCheck(this, Particle);
